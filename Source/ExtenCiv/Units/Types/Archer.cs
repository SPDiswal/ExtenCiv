...
{
    /// <summary>
    ///     Archers move 1 tile per round, have an attacking strength of 2 and a defensive strength of 3.
    /// </summary>
    public sealed class Archer : IUnit<Archer>
    {
        /// <summary>
        ...
        /// </summary>
        public string Type { get; set; } = "Archer";
