...
{
    /// <summary>
    ///     Chariots move 1 tile per round, have an attacking strength of 3 and a defensive strength of 1.
    /// </summary>
    public sealed class Chariot : IUnit<Chariot>
    {
        /// <summary>
        ...
        /// </summary>
        public string Type { get; set; } = "Chariot";
