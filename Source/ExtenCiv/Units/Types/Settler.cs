...
{
    /// <summary>
    ///     Settlers move 1 tile per round, have an attacking strength of 0 and a defensive strength of 3.
    /// </summary>
    public sealed class Settler : IUnit<Settler>
    {
        /// <summary>
        ...
        /// </summary>
        public string Type { get; set; } = "Settler";
