...
namespace ExtenCiv.Resolvers.DryIoc
{
    /// <summary>
    ///     Registers and resolves dependencies using DryIoc.
    /// </summary>
    public sealed class DryIocResolver : IResolver
    {
        ...
        {
            container.RegisterDelegate(_ => dependency);
        }
